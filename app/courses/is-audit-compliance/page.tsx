...
// --- Image Constant (Reusing same logo context) ---
...
const ClipboardCheck = (props: IconProps) => <IconWrapper {...props}><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><path d="M15 2H9a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1Z" /><path d="m9 14 2 2 4-4" /></IconWrapper>;
...
const courseModules: ModuleData[] = [
    { 
        title: "Module 1: The Process of Auditing Information Systems",
        items: [
            "1.1. Management of the Audit Function",
            "1.2. ISACA IT Audit and Assurance Standards",
            "1.3. Risk Analysis and Internal Controls",
            "1.4. Performing an IS Audit",
            "1.5. Control Self-Assessment",
            "1.6. Module Quiz"
        ]
    },
    { 
        title: "Module 2: Governance and Management of IT",
        items: [
    ...
    { 
        title: "Module 3: Information Systems Acquisition & Implementation",
        items: [
            "3.1. Project Management Practices",
            "3.2. Business Application Development",
    ...
    { 
        title: "Module 4: Information Systems Operations & Resilience",
        items: [
            "4.1. Information Systems Operations",
            "4.2. IT Asset Management",
            "4.3. Disaster Recovery Planning (DRP)",
            "4.4. Database Management Systems",
            "4.5. Module Quiz"
        ]
    },
    { 
        title: "Module 5: Protection of Information Assets",
        items: [
            "5.1. Logical Access Controls",
            "5.2. Network Security",
            "5.3. Physical & Environmental Controls",
            "5.4. Data Classification and Privacy",
            "5.5. Module Quiz"
        ]
    },
    { 
        title: "IS Audit & Compliance: Final Assessment",
        items: [
            "Comprehensive Final Exam",
            "Audit Case Study Simulation",
                    ...
                    <div className="p-2 bg-black/20 border-t border-white/5">
                        {module.items?.map((item, idx) => (
                            <div key={idx} className="flex items-center gap-3 py-2 px-4 hover:bg-white/5 rounded text-sm text-slate-400 transition-colors">
                                <div className={`w-1.5 h-1.5 rounded-full ${item.toLowerCase().includes('quiz') || item.toLowerCase().includes('exam') ? 'bg-yellow-500' : 'bg-cyan-900'}`} />
                                <span className={item.toLowerCase().includes('quiz') || item.toLowerCase().includes('exam') ? 'text-white font-semibold' : ''}>
                                    {item}
                                </span>
                            </div>
                        ))}
...
/**
 * MAIN PAGE: IS Audit & Compliance
 */
export default function ISAuditPage() {
  ...
  const languages = [
    "English", "Español", "Français", "Deutsch", "中文(简体)", "日本語"
  ];
         ...
         <div className="container mx-auto relative z-10">
            <div className="max-w-4xl">
                ...
                <div className="inline-flex items-center gap-2 mb-6">
                    ...
                    <span className="text-slate-400 text-xs font-bold uppercase tracking-wider">Information Systems Auditor</span>
                </div>

                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                    IS Audit & <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-500">Compliance</span>
                </h1>
                
                <p className="text-lg text-slate-300 mb-8 max-w-2xl leading-relaxed">
                    Master the art of evaluating systems and protecting assets. Learn to assess vulnerabilities, report on compliance, and validate institutional controls in this comprehensive auditing framework.
                </p>

                <div className="flex flex-wrap gap-4 mb-10">
                    <StatPill icon={Users} label="Enrolled" value="2,109,442" />
                    <StatPill icon={Clock} label="Duration" value="12 Hours" />
                    <StatPill icon={BarChart} label="Level" value="Intermediate" />
                    <StatPill icon={Terminal} label="Case Studies" value="5 Real-World" />
                </div>
              ...
              <div className="lg:col-span-8 space-y-16">
                  ...
                  <div>
                      <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                          <ClipboardCheck className="text-cyan-500" size={24}/> 
                          Course Description
                      </h3>
                      <div className="prose prose-invert prose-slate max-w-none text-slate-400 leading-relaxed">
                          <p className="mb-4">
                              As organizations navigate an increasingly complex regulatory landscape, the need for skilled Information Systems (IS) Auditors has never been greater. This course is designed to bridge the gap between IT operations and strategic risk management.
                          </p>
                          <p>
                              You will delve into the <strong>IS Audit Process</strong>, understanding how to apply risk-based audit strategies. We cover essential frameworks (COBIT, ISO 27001), governance structures, and the lifecycle of information systems—ensuring you are equipped to validate the integrity, confidentiality, and availability of critical data.
                          </p>
                      </div>
                  </div>
                  ...
                  {/* Skills */}
                  <div>
                      <h3 className="text-xl font-bold text-white mb-6">Skills You Will Gain</h3>
                      <div className="flex flex-wrap gap-3">
                          {["IT Governance", "Risk Assessment", "Audit Standards (ISACA)", "Compliance Frameworks", "Disaster Recovery", "Business Continuity", "GDPR & Privacy"].map((skill) => (
                  ...
                  {/* Curriculum */}
                  <div>
                        <h3 className="text-2xl font-bold text-white mb-6">Syllabus</h3>
                  ...
                  <div className="bg-linear-to-r from-slate-900 to-slate-900/50 border border-cyan-900/30 rounded-2xl p-8 flex items-center justify-between">
                        <div>
                            <h3 className="text-xl font-bold text-white mb-2">Earn a Digital Badge</h3>
                            <p className="text-slate-400 text-sm">Complete this course to claim your verified certificate of completion.</p>
                        </div>
                      ...
                      <div className="bg-slate-900/80 backdrop-blur border border-white/10 rounded-2xl p-6 shadow-xl">
                          ...
                          <div className="space-y-4">
                              ...
                              <div className="flex justify-between items-center py-2 border-b border-white/5">
                                  ...
                                  <span className="text-white font-bold text-right">Self-Paced</span>
                              </div>
                              <div className="flex justify-between items-center py-2 border-b border-white/5">
