...
/**
 * COMPONENT: Hacker Background Animation (Reused for consistency)
 */
...
const courseModules: ModuleData[] = [
    ...
    { 
        title: "Introduction to Cybersecurity: Course Final Exam",
        items: [
            "Course Final Exam",
...
export default function CoursePage() {
  ...
  const languages = [
    "العربية", "Bahasa Indonesia", "中文(简体)", "Deutsch", "English", "Español", "Français", 
    "Ελληνικά", "Italiano", "日本語", "한국어", "Nederlands", "Polski", "Português", "Română", 
    "ไทย", "Türkçe", "Український", "Tiếng Việt"
  ];
         ...
         <div className="container mx-auto relative z-10">
            <div className="max-w-4xl">
                ...
                <div className="inline-flex items-center gap-2 mb-6">
                    ...
                    <span className="text-slate-400 text-xs font-bold uppercase tracking-wider">Junior Cybersecurity Analyst</span>
                </div>

                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                    Cybersecurity <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-500">Fundamentals</span>
                </h1>
                
                <p className="text-lg text-slate-300 mb-8 max-w-2xl leading-relaxed">
                    Explore the exciting field of cybersecurity. Learn the basics to protect your personal digital life and gain insights into the biggest security challenges facing the world today.
                </p>

                <div className="flex flex-wrap gap-4 mb-10">
                    <StatPill icon={Users} label="Enrolled" value="8,331,872" />
                    <StatPill icon={Clock} label="Duration" value="6 Hours" />
                    <StatPill icon={BarChart} label="Level" value="Beginner" />
                    <StatPill icon={Terminal} label="Labs" value="7 Interactive" />
                </div>
              ...
              <div className="lg:col-span-8 space-y-16">
                  ...
                  <div>
                      ...
                      <div className="prose prose-invert prose-slate max-w-none text-slate-400 leading-relaxed">
                          <p className="mb-4">
                              Cybersecurity professionals who can protect and defend an organization’s network are in high demand. This introductory course takes you inside the world of cybersecurity. 
                          </p>
                          <p>
                              You will learn cybersecurity basics to protect your personal digital life and gain insights into the biggest security challenges companies, governments, and educational institutions face today. This is your first step towards a future-proof career.
                          </p>
                      </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div className="flex flex-wrap gap-3">
                          {["Cybersecurity", "Threat Detection", "Cyber Best Practices", "Privacy & Data Confidentiality", "Network Vulnerabilities", "Risk Assessment"].map((skill) => (
                      ...
                      <div className="bg-slate-900/80 backdrop-blur border border-white/10 rounded-2xl p-6 shadow-xl">
                          ...
                          <div className="space-y-4">
                              ...
                              <div className="flex justify-between items-center py-2 border-b border-white/5">
                                  ...
                                  <span className="text-white font-bold text-right">Self-Paced or Instructor-Led</span>
                              </div>
                              <div className="flex justify-between items-center py-2 border-b border-white/5">
