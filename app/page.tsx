...
//     <div className="absolute top-0 left-1/4 w-125 h-125 bg-blue-900/20 rounded-full blur-[100px] animate-pulse" />
//     <div className="absolute bottom-0 right-1/4 w-150` h-150 bg-cyan-900/20 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1s' }} />
//     <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-200 bg-indigo-950/20 rounded-full blur-[100px]" />
...
//  * UPDATE: Added optional `link` prop to the interface
//  */
...
// const CourseCard = ({ title, level, price, tags, icon: Icon, features, link }: CourseCardProps) => (
...
//     <div className="absolute inset-0 bg-linear-to-r from-cyan-600/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
    
//     <div className="relative z-10 h-full flex flex-col">
//       <div className="flex justify-between items-start mb-6">
//         <div className="p-3 bg-linear-to-r from-slate-800 to-black rounded-xl border border-cyan-500/20 shadow-lg group-hover:scale-110 transition-transform duration-300 group-hover:border-cyan-400/50">
...
//       <div className="text-sm text-slate-400 mb-6 grow">
...
//         {/* UPDATE: Replaced button with Link component */}
//         <Link 
//             href={link || '#'} 
//             className="p-2 rounded-full bg-white/5 hover:bg-cyan-600 hover:text-black text-slate-400 transition-colors"
//         >
...
//     <div className="w-12 h-12 rounded-lg bg-linear-to-r from-cyan-600 to-blue-800 flex items-center justify-center mb-4 shadow-lg shadow-cyan-900/20 group-hover:scale-110 transition-transform">
...
//   // UPDATE: Added 'link' property to the first course
//   const courses = [
//     { 
...
//       link: "/courses/cybersecurity-fundamentals" // <-- LINK ADDED HERE
//     },
//     { 
...
//       link: "/courses/vapt-ethical-hacking"
//     },
//     { 
...
//       link: "/courses/is-audit-compliance"
//     },
//     { 
...
//       link: "/courses/workshops-awareness"
//     }
//   ];
...
//             <Link 
//                 href="/register" 
//                 className="px-5 py-2.5 bg-linear-to-r from-cyan-600 to-blue-600 text-white font-bold text-sm rounded-lg hover:from-cyan-500 hover:to-blue-500 transition-all hover:scale-105 shadow-lg shadow-cyan-900/20"
//             >
//                 Get Started
//             </Link>
//           </div>
...
//             <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 via-blue-500 to-indigo-400 drop-shadow-[0_0_15px_rgba(6,182,212,0.5)]">
//               Cyber Intelligence
//             </span>
//           </h1>
...
//             <div ref={terminalWindowRef} className="bg-black rounded-xl overflow-hidden aspect-video md:aspect-21/9 relative border border-slate-800 opacity-0">
...
//                      <div className="absolute inset-0 bg-linear-to-b from-transparent via-cyan-500/5 to-transparent h-full w-full animate-scan pointer-events-none" />
...
//                     <button className="w-full bg-linear-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold py-3 rounded transition-all">Submit Request</button>
//                   </div>
//                </div>
//              </div>
//            </div>
...
//              <div className="absolute top-0 left-0 w-full h-full bg-linear-to-b from-transparent to-black/80 -z-10" />
//              <div className="absolute -top-1/2 -right-1/2 w-150 h-150 bg-cyan-600/10 blur-[120px] rounded-full pointer-events-none" />
...
/**
 * DATA SOURCE: SIMULATED ADMIN DATABASE
 * This array mirrors the data structure from your Pricing Database dashboard.
 * Changes here will instantly reflect on the landing page.
 */
const COURSE_DATABASE = [
  { 
    ...
    title: "Cybersecurity Fundamentals", 
    level: "Beginner", 
    price: 12499, // UPDATED PRICE (Was 11999)
    status: "Active", 
    tags: ["Networking", "Defense", "Basics"],
    icon: Shield,
    features: ["Secure Networking", "Threat Detection", "Risk Management"],
  ...
  { 
    ...
    title: "VAPT / Ethical Hacking", 
    level: "Advanced", 
    price: 16999, // UPDATED PRICE (Was 14999)
    status: "Active", 
    tags: ["Pentesting", "Web", "Network"],
    icon: Terminal,
    features: ["Vulnerability Assessment", "Web App Pentesting", "Reporting & Risk"],
  ...
  { 
    ...
    title: "IS Audit & Compliance", 
    level: "Intermediate", 
    price: 13999, // UPDATED PRICE (Was 13499)
    status: "Active", 
    tags: ["ISO 27001", "RBI", "CERT-In"],
    icon: Briefcase,
    features: ["ISO 27001 Controls", "Banking Audit Overview", "IT General Controls (ITGC)"],
  ...
  { 
    ...
    title: "Workshops & Awareness", 
    level: "All Levels", 
    price: 3499, // UPDATED PRICE (Was 2999)
    status: "Active", // NOTE: Changed from 'Offline' to 'Active' for demo purposes
    tags: ["Phishing", "AI", "Career"],
    icon: Globe,
    features: ["AI in Cybersecurity", "Social Engineering", "Career Guidance"],
    link: "/courses/workshops-awareness"
...
interface CourseCardProps {
    title: string;
    level: string;
    price: number; // Changed to number to accept DB value
    tags: string[];
    icon: React.ComponentType<IconProps>;
    features: string[];
    link?: string;
...
const CourseCard = ({ title, level, price, tags, icon: Icon, features, link }: CourseCardProps) => (
  <div className="group relative bg-slate-900/60 backdrop-blur-md border border-cyan-900/30 rounded-2xl p-6 hover:bg-slate-800/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-cyan-900/20 overflow-hidden">
    ...
    <div className="relative z-10 h-full flex flex-col">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-white/5 mt-auto">
        <span className="text-2xl font-bold text-white tracking-tight">{formatCurrency(price)}</span>
        <Link 
            href={link || '#'} 
            className="p-2 rounded-full bg-white/5 hover:bg-cyan-600 hover:text-black text-slate-400 transition-colors"
        >
    ...
    <div className="min-h-screen bg-black text-slate-200 font-sans selection:bg-cyan-900/50 selection:text-cyan-100 overflow-x-hidden">
      ...
      <section id="training" className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* UPDATED: Mapping strictly from the COURSE_DATABASE constant to ensure pricing consistency */}
            {COURSE_DATABASE.filter(c => c.status === 'Active').map((course, idx) => (
              <CourseCard key={idx} {...course} />
            ))}
          </div>
        </div>
