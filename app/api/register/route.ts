...
//       photoBase64: body.photoBase64, 
//       signatureBase64: body.signatureBase64,
//       aadhaarBase64: body.aadhaarBase64,
//       collegeIdBase64: body.collegeIdBase64,
//       nocBase64: body.nocBase64,
...
//       // --- Checklist Booleans ---
//       checkAadhaar: body.checkAadhaar || false,
//       checkCollegeId: body.checkCollegeId || false,
//       checkNoc: body.checkNoc || false,
//       checkPhoto: body.checkPhoto || false,
...
//     // ============================================================
//     // 5. SEND EMAIL LOGIC (Updated Content)
//     // ============================================================
//     try {
//       const transporter = nodemailer.createTransport({
//         service: 'gmail',
...
//         from: `"Cyber Intelligence Academy" <${process.env.EMAIL_USER}>`,
//         to: body.email,
//         subject: 'Action Required: Registration & Payment Details', // Updated Subject
//         html: `
//           <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f8fafc; padding: 20px; border: 1px solid #e2e8f0;">
...
//               <p style="color: #475569; line-height: 1.6;">
//                 Your application for the <strong>Internship and Training</strong> has been successfully processed.
//               </p>
...
//                 </p>
//                 <p style="margin: 5px 0 0 0; color: #c2410c;">
//                   For <strong>Payment</strong> and further program details, please contact our Helpline Number immediately.
//                 </p>
//               </div>
...
//               <div style="text-align: center;">
//                 <p style="color: #64748b; font-size: 14px; margin-bottom: 10px;">For Payment & Details Contact:</p>
//                 <div style="display: inline-block; background-color: #1e293b; color: #ffffff; padding: 12px 24px; border-radius: 50px; font-weight: bold; font-size: 16px;">
//                   📞 Help Line: 8252866584
//                 </div>
//               </div>
//             </div>
...
export async function POST(request: Request) {
  try {
    ...
    // ============================================================
    // 5. SEND EMAIL LOGIC (Updated Header)
    // ============================================================
    try {
      const transporter = nodemailer.createTransport({
        service: 'gmail',
      ...
      const mailOptions = {
        from: `"Cyber Intelligence Academy" <${process.env.EMAIL_USER}>`,
        to: body.email,
        subject: 'Action Required: Registration & Payment Details',
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f8fafc; padding: 20px; border: 1px solid #e2e8f0;">
            
            <div style="background-color: #0f172a; padding: 25px 20px; text-align: center; border-bottom: 4px solid #10b981; border-radius: 8px 8px 0 0;">
              <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: bold;">Cyber Intelligence Academy</h1>
              <p style="color: #10b981; margin: 5px 0 15px 0; font-size: 12px; font-weight: bold; letter-spacing: 1px; text-transform: uppercase;">
                BACKED BY DREAMWORKS INFOTECH PVT. LTD
              </p>
              <div style="border-top: 1px solid #334155; margin: 10px 40px;"></div>
              <h2 style="color: #e2e8f0; margin: 15px 0 0 0; font-size: 18px; font-weight: normal;">Registration Successful</h2>
            </div>
